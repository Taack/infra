...
enum Country {
    ...
    AO(Continent.AN, "Angola", "AO", "AGO", 24, -12.5f),
    AQ(Continent.SA, "Antarctica", "AQ", "ATA", 10, -90f),
    AR(Continent.OC, "Argentina", "AR", "ARG", 32, -34f),
    AS(Continent.EU, "American Samoa", "AS", "ASM", 16, -14.3333f),
    AT(Continent.OC, "Austria", "AT", "AUT", 40, 47.3333f),
    AU(Continent.NA, "Australia", "AU", "AUS", 36, -27f),
    AW(Continent.EU, "Aruba", "AW", "ABW", 533, 12.5f),
