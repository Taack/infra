...
* Inner Filter: pass many filters at once, allowing many list of independent objects, useful for listing Addresses from Geographical Area (2 independent classes).
