...
* Embedded Sections on filters
* Mask filter section if inputs are empty
* Inner Filter OR Filter extension: pass many filters at once, allowing many list of independent objects, useful for listing Addresses from Geographical Area (2 independent classes).
